# gh CLI — Other Commands

> **Reference file for [gh-cli skill](../SKILL.md)**

## Contents

- [API Requests (gh api)](#api-requests-gh-api) ← most useful for scripting
- [Codespaces (gh codespace)](#codespaces-gh-codespace)
- [Organizations (gh org)](#organizations-gh-org)
- [Search (gh search)](#search-gh-search)
- [Labels (gh label)](#labels-gh-label)
- [SSH Keys (gh ssh-key)](#ssh-keys-gh-ssh-key)
- [GPG Keys (gh gpg-key)](#gpg-keys-gh-gpg-key)
- [Status (gh status)](#status-gh-status)
- [Configuration (gh config)](#configuration-gh-config)
- [Extensions (gh extension)](#extensions-gh-extension)
- [Aliases (gh alias)](#aliases-gh-alias)
- [Rulesets (gh ruleset)](#rulesets-gh-ruleset)
- [Attestations (gh attestation)](#attestations-gh-attestation)
- [Completion (gh completion)](#completion-gh-completion)
- [Preview (gh preview)](#preview-gh-preview)
- [Agent Tasks (gh agent-task)](#agent-tasks-gh-agent-task)
