...
description: Comprehensive guide for creating software diagrams using Mermaid syntax. Covers class, sequence, flowchart, ER, C4, state, git graphs, pie, and Gantt charts for any architecture or flow.
---
...
- When asked to create, visualize, or document software through diagrams
- For class, sequence, flowchart, ER, C4, state, git graph, pie, or Gantt charts
- When explaining system architecture, database design, or application flows
