---
name: refactor
description: Surgical code refactoring to improve maintainability without changing behavior. Covers extracting functions, renaming, breaking down god functions, improving type safety, and eliminating code smells.
license: MIT
---
